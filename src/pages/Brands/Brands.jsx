    ...
    <div className='p-[28px] flex flex-col gap-[40px] w-[1030px]'>
      <div className="flex justify-between items-center">
        <div className="flex items-start gap-[8px]">
          ...
          <Link className='bg-[#DBEAFE] text-[#1D4ED8] p-[8px_16px] rounded-[4px]' to={"/dashboard/brands"} ><h1 className='text-[16px] font-[500]'>Brands</h1></Link>
      ...
      <section className='flex gap-[40px] items-start'>
        ...
        <div className='p-[28px] flex flex-col gap-[24px] w-[524px] rounded-[4px] border'>
      ...
      >
        <Box sx={style}>
          ...
          <div className="flex justify-end mt-[5%]">
            ...
            <button onClick={() => { dispatch(putBrands({ Id: idx, BrandName: brandsName })), handleCloseEdit() }} className='font-serif w-[25%] h-[40px] bg-[#1E5EFF] text-[white]  rounded-[5px] '>Save</button>
          </div>
        </Box>
      </Modal>
    </div>
