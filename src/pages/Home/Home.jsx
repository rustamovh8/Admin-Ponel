    ...
    <div className="p-[28px] flex flex-col gap-[24px]">
      ...
      <div className="flex items-start gap-[16px]">
        <div className="flex flex-col gap-[16px]">
          ...
          <div className="border-[2px] rounded-[4px] p-[19px_20px] flex flex-col gap-[10px] ">
        ...
        <div className="flex flex-col gap-[16px] p-[12px_16px_20px_16px] items-center rounded-[4px] w-[311px] border-[2px]">
      ...
      <div className="flex justify-between items-center mt-[20px]">
        <div className="w-[48%] border-[2px] rounded-[4px] p-[20px]">
